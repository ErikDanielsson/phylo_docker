...
for package in "tree" "PySide6" "scipy" "seaborn" "tabulate" "matplotlib" "Bio" "dendropy" 
# not checking for (must be updated): "PySimpleGUI"
do
    test=$(cat <<EOF
...
UE="UE"; SE="SE"
for package in "Rcpp" "devtools" "rjson" "rlist" "data.table" "reshape2" "dplyr" "Rmpfr" "sf" "distributions3" "HDInterval" "ratematrix" "diversitree" "TreeSim" "TreePar" "corHMM" "hisse" "OUwie" "castor" "TESS" "RPANDA" "rphenoscape" "treeplyr" "rphenoscate" "paleobuddy" "CRABS" "mcmcse" "rase" "treebalance" "poweRbal" "treestats" "cowplot" "tikzDevice" "ggtree" "RevGadgets" "FossilSim" 
do
...
for package in "Combinatorics" "PProf" "Distributions" "Phylo" "Optim" "RCall" "Tapestree" "Parameters" "StaticArrays" "BenchmarkTools" "SIMD" "Setfield" "KernelDensity" "PDMats" "SpecialFunctions" "ExponentialUtilities" "StatsBase" 
do
...
beast -version | head -n 2 | tail -n 1

# BEAGLE
echo ""; echo "Checking for Beagle..."; echo ""
beast -beagle_info | tail -n 10 | head -n 1